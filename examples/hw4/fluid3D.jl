...
directions(::D3Q19) = (
        Point(1/2, 0, 0), Point(0, 0, 1/2), Point(0, 1/2, 0), Point(1/2, 0, 1/2),
        Point(-1/2, 0, 1/2), Point(1/2, 1/2, 0), Point(-1/2, 1/2, 0), Point(0, 1/2, 1/2),
        Point(0, 1/2, -1/2), Point(0, -1/2, 1/2), Point(0, 0, 0), 
        Point(0, -1/2, -1/2), Point(1/2, -1/2, 0), Point(-1/2, -1/2, 0), Point(1/2, 0, -1/2),
        Point(-1/2, 0, -1/2), Point(0, -1/2, 0), Point(0, 0, -1/2), Point(-1/2, 0, 0),
    )
...
weights(::D3Q19) = (1/36, 1/36, 1/9, 1/9, 4/9, 1/9, 1/9, 1/36, 1/36)
